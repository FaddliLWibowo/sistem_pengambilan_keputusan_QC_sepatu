...
<div style="margin:auto; padding:50px 0 30px; text-align:center">
    <h1>Sistem Pengambil keptusan </h1>
    <p>PT.Adis dimension Footware</p>
</div>
<div style="margin:auto">
    <form class="rounded_3 shadow_3" action="proses_login.php" method="post" style="width:400px; margin:auto;">
